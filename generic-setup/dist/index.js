...
console.log(utils.sh(`cd ../../_actions/zowe-actions/shared-actions/generic-setup && ls`))
var branchesJsonText = fs.readFileSync('../../_actions/zowe-actions/shared-actions/generic-setup/branches.json')
